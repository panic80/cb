...
describe("bubbleExtractor", () => {
  describe("extractInnerContent", () => {
    ...
    it("should extract content from deeply nested structures", () => {
      const input =
        "<div><message><content>This is deeply nested</content></message></div>";
    ...
    it("should handle text with no clear structure", () => {
      ...
      expect(extractInnerContent(input)).toBe(
  ...
  describe("extractNestedContent", () => {
    it("should handle different input types", () => {
      // String input
      expect(extractNestedContent("<div>Text content</div>")).toBe(
        "Text content"
      );
    ...
    it("should extract content from a complex chat structure", () => {
      ...
      expect(result).toContain(
        "Travel allowance rates for incidental expenses"
      );
      expect(result).toContain(
        "Reason: The CFTDTI refers to the NJC Travel Directive"
      );
    });
  });
});

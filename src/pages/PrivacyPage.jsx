...
export default function PrivacyPage({ theme, onThemeChange }) { // Accept theme props
  // Back navigation is handled by PageLayout

  return (
    <PageLayout title="Privacy Disclaimer" theme={theme} onThemeChange={onThemeChange}>
      ...
      <div className="text-center mb-8 sm:mb-12 transition-all duration-300">
        ...
        <h1 className="text-2xl sm:text-4xl font-bold mb-2 sm:mb-3 text-[var(--text-primary)] transition-colors duration-300">Privacy Information</h1>
        <p className="text-base sm:text-lg text-[var(--text-secondary)] transition-colors duration-300 px-4 max-w-2xl mx-auto">How your data is handled.</p>
      </div>
      ...
      <div className="bg-[var(--card)] rounded-xl shadow-lg border border-[var(--border)] p-4 sm:p-6 transition-all duration-300 space-y-6">
        <div>
          <h2 className="text-xl sm:text-2xl font-semibold mb-3 text-[var(--text-primary)] border-b border-[var(--border)] pb-2">Privacy Overview</h2>
        ...
        <div>
          <h2 className="text-xl sm:text-2xl font-semibold mb-3 text-[var(--text-primary)] border-b border-[var(--border)] pb-2">Data Retention Summary</h2>
          <p className="text-base text-[var(--text-secondary)] mb-2">

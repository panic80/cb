...
const FAQPage = ({ theme, onThemeChange }) => { // Accept theme props
  return (
    <PageLayout title="Frequently Asked Questions" theme={theme} onThemeChange={onThemeChange}>
       ...
       <div className="text-center mb-8 sm:mb-12 transition-all duration-300">
         ...
         <h1 className="text-2xl sm:text-4xl font-bold mb-2 sm:mb-3 text-[var(--text-primary)] transition-colors duration-300">FAQs</h1>
         <p className="text-base sm:text-lg text-[var(--text-secondary)] transition-colors duration-300 px-4 max-w-2xl mx-auto">Find answers to common questions.</p>
       </div>

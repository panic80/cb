...
export default function PageLayout({
  ...
  return (
    <div className={wrapperClasses}>
      {/* Navigation Bar */}
      <div className="fixed top-0 left-0 right-0 z-50 bg-[var(--bg-primary)]/80 backdrop-blur-sm border-b border-[var(--border-color)] px-4 py-2 flex justify-between items-center h-16">
        {" "}
        {/* Fixed height */}
